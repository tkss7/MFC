...
//	CMemberMgrDlg dlg(nullptr);
	...
	if (dlg.DoModal() == IDOK) {
		//CMemberPtr pNewMember = dlg.GetMemberPtr();
		//pMember->operator=(pNewMember);
		//*pMember = pNewMember;

		*pMember = dlg.GetMemberPtr();

		//pMember->m_strId = pNewMember->m_strId;
		//pMember->m_strName = pNewMember->m_strName;
		//pMember->m_nPostCode = pNewMember->m_nPostCode;
		//pMember->m_strAddress = pNewMember->m_strAddress;
		//pMember->m_bSex = pNewMember->m_bSex;
		//pMember->m_strPhone1 = pNewMember->m_strPhone1;
		//pMember->m_strPhone2 = pNewMember->m_strPhone2;
		//pMember->m_strPhone3 = pNewMember->m_strPhone3;
		//pMember->m_nAge = pNewMember->m_nAge;
		//pMember->m_nHobby = pNewMember->m_nHobby;
