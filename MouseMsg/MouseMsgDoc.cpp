...
// MouseMsgDoc.cpp: CMouseMsgDoc 클래스의 구현
//
...
CMouseMsgDoc::CMouseMsgDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CMouseMsgDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CMouseMsgDoc::InitializeSearchContent()
{
...
void CMouseMsgDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
