...
// SDI_Demo.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
CSDIDemoApp::CSDIDemoApp() noexcept
{
	...
	SetAppID(_T("SDIDemo.AppID.NoVersion"));

	// TODO: 여기에 생성 코드를 추가합니다.
	// InitInstance에 모든 중요한 초기화 작업을 배치합니다.
}

// 유일한 CSDIDemoApp 개체입니다.
